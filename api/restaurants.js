export default async function handler(req, res) {
    ...
    try {
        ...
        const swiggyUrl = resId
            ? `https://www.swiggy.com/mapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=18.9690247&lng=72.8205292&restaurantId=${resId}&catalog_qa=undefined&submitAction=ENTER`
